...
$oeuvres = [
    1 => [
        ...
        'img_oeuvre' => 'img/clark-van-der-beken.png',
        'description_oeuvre' => 'Mia Tozerski est une artiste peintre ukrainienne réfugiée de la guerre. Sur cette œuvre, Dodomu ("domicile" en ukrainien), elle nous montre la tristesse du peuple ukrainien qu\'elle partage, ayant elle-même dû quitter son foyer.',
    ],
    2 => [
        'id_oeuvre' => 2,
        'nom_oeuvre' => 'Aashaaheen Baadal',
        'artiste' => 'Anaisha Devi',
        'img_oeuvre' => 'img/pawel-czerwinski-3.png',
        'description_oeuvre' => 'Sur cette oeuvre conceptuelle à la fois organique, minérale et liquide, Anaisha Devi nous transporte dans un nuage noir envoûtant. Un sombre tableau qui, par son verni éclatant, rayonne tel un marbre poli. Une oeuvre à la cohérence transcendantale, exécutée à la perfection',
    ],
    3 => [
        'id_oeuvre' => 3,
        'nom_oeuvre' => 'Nightlife Traffic',
        'artiste' => 'Andrew Forsythe',
        'img_oeuvre' => 'img/dan-cristian-padure.png',
    ...
    4 => [
        ...
        'img_oeuvre' => ' img/steve-johnson-5.png',
    ...
    5 => [
        ...
        'img_oeuvre' => 'img/steve-johnson.png',
    ...
    6 => [
        ...
        'img_oeuvre' => ' img/pawel-czerwinski.png',
        'description_oeuvre' => 'Vivamus commodo non libero at hendrerit. In lacinia dui sit amet pellentesque iaculis. Donec at ultricies sem porttitor.',
    ],
    7 => [
        'id_oeuvre' => 7,
        'nom_oeuvre' => 'Digital Negative',
        'artiste' => 'Hamish McKee',
        'img_oeuvre' => 'img/jazmin-quaynor.png',
        'description_oeuvre' => 'Integer in nisl posuere, pulvinar ex ac, tincidunt risus. Nullam vel lorem et leo dignissim accumsan. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent tempor, magna non consectetur dapibus, est libero iaculis lacus, eget semper turpis orci vitae felis. Fusce eget molestie.',
    ],
    8 => [
        'id_oeuvre' => 8,
        'nom_oeuvre' => 'Blast from the past',
        'artiste' => 'Juliette Baskerville',
        'img_oeuvre' => 'img/steve-johnson-6.png',
        'description_oeuvre' => 'Nunc fermentum purus dapibus justo fermentum auctor. Maecenas non tincidunt leo. Morbi vitae iaculis sem. Donec quis scelerisque massa. Fusce quis accumsan diam, et interdum lectus. Suspendisse mattis pulvinar vehicula. Duis nisi.',
    ],
    9 => [
        'id_oeuvre' => 9,
        'nom_oeuvre' => 'Hurricane',
        'artiste' => 'Natalie Wellington',
        'img_oeuvre' => 'img/victor-grabarczyk.png',
    ...
    10 => [
        ...
        'img_oeuvre' => 'img/pawel-czerwinski-2.png',
    ...
    11 => [
        ...
        'img_oeuvre' => 'img/steve-johnson-2.png',
    ...
    13 => [
        ...
        'img_oeuvre' => 'img/orfeas-green.png',
        'description_oeuvre' => 'Donec semper a massa quis congue. In malesuada lorem ligula, ut posuere magna pulvinar in. Proin vitae enim gravida, commodo odio.',
    ],
    14 => [
        'id_oeuvre' => 14,
        'nom_oeuvre' => 'Mirage',
        'artiste' => 'Stéphanie Kaiser',
        'img_oeuvre' => 'img/steve-johnson-4.png',
    ...
    15 => [
        ...
        'img_oeuvre' => 'img/steve-johnson-3.png',
        'description_oeuvre' => 'Curabitur dui odio, porta vel tempor sed, consectetur vitae mi. Interdum et malesuada fames ac ante ipsum primis in faucibus. Orci varius natoque penatibus nec.',
    ],
];
?>